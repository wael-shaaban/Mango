...
namespace Mango.Services.RewardsApi.Messaging
{
    public class RabbitMqServiceBusConsumer : IRabbitMqServiceBusConsumer
    {
        ...
        private readonly RewardService emailService;
        private string _consumerCancelTag;
        public RabbitMqServiceBusConsumer(IOptions<RabbitMQSettings> rabbitmqSettings, RewardService emailService)
        {
